...
1. DT1_Assignment_1:
   ...
   * Skills learnt from this assignment can be used in the future by adapting the functions learnt from this assignment to future situations, and example of this would be using a "for loop" **Condider deleting assignment 1**
